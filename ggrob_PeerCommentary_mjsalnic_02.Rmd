---
title: "ggrob_OriginalHomeworkCode_02"
author: "Gianna Grob"
date: "9/16/2019"
...
```{r}
x <- 0:30 #Set our range of 0 to 30
l <- 15 #Set our lambda value as the amount of calls heard which is 15.
barplot(ppois(q=x,lambda=l),ylim=0:1,space=0, names.arg=x,xlab="x",ylab="Pr(X ≤ x)",main="Cumulative Probability") #Create barplot with the two varibles for cumulative probability
```

Note: Is that the graph he wants????
...
Note: In my histogram I set probability to TRUE to allow for probabiltiy to be shown. I have seen this in examples online. Is that needed for this graph? 
...
#### Summary from Majo: Overall our code looks similar, for question 4 I have the same inquiry if my graph is correct. It seems to me that the graph asked is for  the probability mass function (Because it is mentioned in question 6)
